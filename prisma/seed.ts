...
async function main() {
  ...
  const cars = [
    { vehicle: 'Model S', type: 'Sedan', color: 'Red', fuel: 'Electric', manufacturer: 'Tesla', mass: 2159, imageUrl: '/uploads/tesla.jpg', price: 74999, description: 'Luxury electric sedan with autopilot. Price: $74,999.', yearMade: 2023, horsePower: 670 },
    ...
    { vehicle: 'X5', type: 'SUV', color: 'White', fuel: 'Gasoline', manufacturer: 'BMW', mass: 2100, imageUrl: '/uploads/bmw_x5.jpg', price: 85000, description: 'Premium mid-size luxury SUV. Price: $85,000.', yearMade: 2023, horsePower: 523 },
    ...
    { vehicle: 'Defender', type: 'SUV', color: 'Gray', fuel: 'Diesel', manufacturer: 'Land Rover', mass: 2200, imageUrl: '/uploads/landrover_defender.jpg', price: 75000, description: 'Rugged off-road capable luxury SUV. Price: $75,000.', yearMade: 2023, horsePower: 395 },
    { vehicle: 'Taycan', type: 'Sedan', color: 'White', fuel: 'Electric', manufacturer: 'Porsche', mass: 2050, imageUrl: '/uploads/porsche_taycan.jpg', price: 110000, description: 'High-performance electric luxury sedan. Price: $110,000.', yearMade: 2023, horsePower: 750 },
    ...
    { vehicle: 'G70', type: 'Sedan', color: 'Black', fuel: 'Gasoline', manufacturer: 'Genesis', mass: 1700, imageUrl: '/uploads/genesis_g70.jpg', price: 42000, description: 'Luxury sports sedan with sleek design. Price: $42,000.', yearMade: 2023, horsePower: 365 },
    { vehicle: 'Grand Cherokee', type: 'SUV', color: 'White', fuel: 'Hybrid', manufacturer: 'Jeep', mass: 2300, imageUrl: '/uploads/jeep_grandcherokee.jpg', price: 58000, description: 'Spacious hybrid off-road SUV. Price: $58,000.', yearMade: 2023, horsePower: 375 },
    ...
    { vehicle: 'Levante', type: 'SUV', color: 'White', fuel: 'Gasoline', manufacturer: 'Maserati', mass: 2100, imageUrl: '/uploads/maserati_levante.jpg', price: 88000, description: 'Exotic Italian luxury SUV. Price: $88,000.', yearMade: 2023, horsePower: 550 },
    ...
    { vehicle: 'Polestar 3', type: 'SUV', color: 'White', fuel: 'Electric', manufacturer: 'Polestar', mass: 2300, imageUrl: '/uploads/polestar_3.jpg', price: 83900, description: 'Futuristic electric luxury SUV. Price: $83,900.', yearMade: 2024, horsePower: 489 },
    { vehicle: 'Purosangue', type: 'SUV', color: 'Red', fuel: 'Gasoline', manufacturer: 'Ferrari', mass: 2033, imageUrl: '/uploads/ferrari_purosangue.jpg', price: 400000, description: 'Ferrari’s first luxury SUV. Price: $400,000.', yearMade: 2023, horsePower: 715 },
    { vehicle: 'Lucid Gravity', type: 'SUV', color: 'Gray', fuel: 'Electric', manufacturer: 'Lucid Motors', mass: 2300, imageUrl: '/uploads/lucid_gravity.jpg', price: 120000, description: 'High-performance electric luxury SUV. Price: $120,000.', yearMade: 2024, horsePower: 800 },
    { vehicle: 'E-Type', type: 'Coupe', color: 'British Racing Green', fuel: 'Gasoline', manufacturer: 'Jaguar', mass: 1250, imageUrl: '/uploads/jaguar_etype.jpg', price: 250000, description: 'Timeless British sports car. Price: $250,000.', yearMade: 1965, horsePower: 265 },
    { vehicle: 'Bel Air', type: 'Sedan', color: 'Red/White', fuel: 'Gasoline', manufacturer: 'Chevrolet', mass: 1497, imageUrl: '/uploads/chevrolet_belair.jpg', price: 2400, description: 'Classic American beauty from the 50s. Price: $2,400.', yearMade: 1957, horsePower: 185 },
    { vehicle: 'GT40', type: 'Coupe', color: 'White/Blue Stripes', fuel: 'Gasoline', manufacturer: 'Ford', mass: 980, imageUrl: '/uploads/ford_gt40.jpg', price: 10000000, description: 'Legendary Le Mans-winning race car. Price: $10,000,000.', yearMade: 1968, horsePower: 485 },
    { vehicle: '300SL Gullwing', type: 'Coupe', color: 'Silver', fuel: 'Gasoline', manufacturer: 'Mercedes-Benz', mass: 1295, imageUrl: '/uploads/mercedes_300sl.jpg', price: 1400000, description: 'Iconic luxury coupe with gullwing doors. Price: $1,400,000.', yearMade: 1955, horsePower: 240 },
    { vehicle: '356 Speedster', type: 'Convertible', color: 'Light Blue', fuel: 'Gasoline', manufacturer: 'Porsche', mass: 760, imageUrl: '/uploads/porsche_356.jpg', price: 450000, description: 'Elegant and lightweight classic Porsche. Price: $450,000.', yearMade: 1956, horsePower: 95 },
    { vehicle: '911 Turbo S', type: 'Coupe', color: 'Yellow', fuel: 'Gasoline', manufacturer: 'Porsche', mass: 1640, imageUrl: '/uploads/porsche_911_turbo_s.jpg', price: 210000, description: 'Super fast and luxurious sports coupe. Price: $210,000.', yearMade: 2024, horsePower: 640 },
    { vehicle: 'Huracán Evo', type: 'Coupe', color: 'Orange', fuel: 'Gasoline', manufacturer: 'Lamborghini', mass: 1422, imageUrl: '/uploads/lamborghini_huracan.jpg', price: 265000, description: 'Exotic Italian supercar with a V10. Price: $265,000.', yearMade: 2023, horsePower: 631 },
