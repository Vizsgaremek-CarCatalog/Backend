...
async function main() {
  console.log('Seeding database with fake car data...');
     ...
     [
        ...
        { vehicle: 'GT40', type: 'Coupe', color: 'White/Blue Stripes', fuel: 'Gasoline', manufacturer: 'Ford', mass: 980, imageUrl: 'http://localhost:3000/uploads/ford_gt40.jpg', price: 10000000, description: 'Legendary Le Mans-winning race car. Price: $10,000,000.', yearMade: 1968, horsePower: 485 },
