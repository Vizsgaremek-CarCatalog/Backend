...
async function main() {
  console.log('Seeding database with fake car data...');
     ...
     const cars = 
     [
      { vehicle: 'Model S', type: 'Sedan', color: 'Red', fuel: 'Electric', manufacturer: 'Tesla', mass: 2000, imageUrl: 'http://localhost:3000/uploads/red.jpg', price: 79999, description: 'Luxury electric sedan with autopilot. Price: $79,999.', yearMade: 2023, horsePower: 670 },
      { vehicle: 'Civic', type: 'Sedan', color: 'Blue', fuel: 'Gasoline', manufacturer: 'Honda', mass: 1400, imageUrl: 'http://localhost:3000/uploads/honda_civic.jpg', price: 25000, description: 'Reliable and fuel-efficient compact car. Price: $25,000.', yearMade: 2022, horsePower: 158 },
