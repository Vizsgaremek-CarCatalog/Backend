...
async function main() {
  ...
  const cars = [
    ...
    { vehicle: 'Lucid Gravity', type: 'SUV', color: 'Black', fuel: 'Electric', manufacturer: 'Lucid Motors', mass: 2300, imageUrl: '/uploads/lucid_gravity.jpg', price: 120000, description: 'High-performance electric luxury SUV. Price: $120,000.', yearMade: 2024, horsePower: 800 },
    ...
    { vehicle: 'Bel Air', type: 'Sedan', color: 'Red/White', fuel: 'Gasoline', manufacturer: 'Chevrolet', mass: 1600, imageUrl: '/uploads/chevrolet_belair.jpg', price: 90000, description: 'Classic American beauty from the 50s. Price: $90,000.', yearMade: 1957, horsePower: 283 },
    { vehicle: 'GT40', type: 'Coupe', color: 'White/Blue Stripes', fuel: 'Gasoline', manufacturer: 'Ford', mass: 980, imageUrl: '/uploads/ford_gt40.jpg', price: 1000000, description: 'Legendary Le Mans-winning race car. Price: $10,000,000.', yearMade: 1968, horsePower: 485 },
